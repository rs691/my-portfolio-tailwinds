...
function Card() {
  ...
  <div className="relative bg-current-900 px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
        ...
        <div className="space-y-6 py-8 text-base leading-7 text-gray-600">
          ...
          <ul className="space-y-4">
            <li className="flex items-center">
              ...
              <p className="ml-4">
                Customizing your
                <code className="text-sm font-bold text-white-900">tailwind.config.js</code> file
              </p>
            </li>
            <li className="flex items-center">
              <svg className="h-6 w-6 flex-none fill-sky-100 stroke-sky-500 stroke-2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p className="ml-4">
                Extracting classNamees with <code className="text-sm font-bold text-gray-900">@apply</code>
              </p>
            </li>
            <li className="flex items-center">
              <svg className="h-6 w-6 flex-none fill-sky-100 stroke-sky-500 stroke-2" strokeLinecap="round" strokeLinejoin="round">
